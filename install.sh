...
zw \zw $system.OBJ.Compile("FHIRHL7V2DEMOPKG.FoundationProduction")

do \$SYSTEM.SQL.Execute("update HS_Registry_Service.HTTP set host = 'fhirhl7v2demo'")

d ##class(Ens.Config.Credentials).SetCredential("HS_Services","HS_Services","$password",1)

do \$classmethod("Ens.Director", "SetAutoStart", "FHIRHL7V2DEMOPKG.FoundationProduction", 0)
